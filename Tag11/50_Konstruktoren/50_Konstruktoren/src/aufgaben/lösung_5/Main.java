...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        new Spieler("Hugo Maier", 0);
        new Spieler("Susi Sorglos", 0);
        new Spieler("Fred Feuerstein", 0);
        new Spieler("Marie Müller", 0);

        new Spieler("Fritz Mustermann", 1);
        new Spieler("Walter wars :-)", 1);
        new Spieler("Sigrid de Vries", 1);
        new Spieler("Annemarie Rosenbaum", 1);

        Spielverlauf.dasTurnier();
