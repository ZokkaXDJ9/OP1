...
public class Array
{
	public static void main(String[] args)
	{
		...
		intArray[9] = 123;
		//intArray[10] = 0;
		// Programmabsturz! ArrayIndexOutOfBoundsException -> Anzahl = 10: da wir mit 0 beginnen, geht es maximal bis 9!
		...
		// Gebe ich nur die Variable aus, erhalte ich als Ausgabe eine Hash-Entsprechung des Array-Objektes.
		System.out.printf("%x\n", intArray3.hashCode());
		...
		double[] dArray = {1.1, 22.22, 3.3333};
		...
		// über Substring:
		System.out.printf("Über Substring: %s\n", sArray[1].substring(4, 10));
		...
		String beispielString2 = beispielString.replace('a', 'z');
		System.out.println(beispielString);
		System.out.println(beispielString2);
		...
		beispielString = String.valueOf(charArray);
		System.out.println("Über Character-Array veränderter String: " + beispielString);
		...
		ausgabe(1,2,3,4,5,24,42,120,444,1000); // Mit varargs kann ich Werte einfach durch Komma getrennt übergeben.
		ausgabe(intArray5); // Oder einfach ein Array übergeben.
