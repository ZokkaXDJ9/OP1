...
public class Lösung_4v2
{
    ...
    public static void main(String[] args)
    {
        ...
        String binär = toBinaryString(eingabe);
    ...
    static String toBinaryString(String text)
    {
        ...
        for (int i = 0; i < text.length(); i++)
        {
            ...
            else
            {
                ...
                sb.append(String.format("%016d ", Long.parseLong(binary))); // Long, um mehr als nur die ASCII-Tabelle abbilden zu können (UTF-8).
            }
        }
